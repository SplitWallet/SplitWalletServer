package org.example.expensesuserservice.validation;

import jakarta.persistence.EntityNotFoundException;
import jakarta.validation.ConstraintViolationException;
import jakarta.ws.rs.ForbiddenException;
import jakarta.ws.rs.NotAuthorizedException;
import org.example.expensesuserservice.ErrorResponse;
import org.example.expensesuserservice.config.CustomFeignException;
...
public class ErrorHandlingControllerAdvice {
	...
	@ResponseBody
	public ResponseEntity<ErrorResponse> onCustomFeignException(CustomFeignException e) {
